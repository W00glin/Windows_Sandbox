...
REM === Email Client Installation ===
echo Downloading and installing Thunderbird...
curl -L -o thunderbird_installer.exe "https://download.mozilla.org/?product=thunderbird-latest&os=win64&lang=en-US"
if exist thunderbird_installer.exe (
    start /wait thunderbird_installer.exe /silent
)
...
echo - Thunderbird in the Start Menu
